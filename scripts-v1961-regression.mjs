...
ok(app.includes("if(sceneHasSpokenContent(scene)&&!sceneHasValidatedLipSync(project||{},scene))return '';"),'unsynced speaking source still exposes a video overlay status');
