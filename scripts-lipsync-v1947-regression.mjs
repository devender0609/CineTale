...
const checks=[
  [src.includes("const APP_VERSION = '1.9.81'"),'app version advanced'],
  ...
  [src.includes("if(scene?.videoUrl)return '';")&&!src.includes('Source preview + approved voice'),'user video overlay has no provider/debug/status wording'],
