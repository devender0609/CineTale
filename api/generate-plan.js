...
characters:[{id,name,role,age,appearance,background,personality,voice,languages,wardrobe,locked,entityType,sacredIdentity,representationMode,canonicalVisualCues[]}]
...
episodes:[{number,title,synopsis,storyText,scenes:[{id,number,title,durationSec,purpose,visual,narration,dialogue[],audioDirection,narrationStyle,music,sfx,camera,tier,act}]}]
