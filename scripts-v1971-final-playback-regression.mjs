...
for(const x of must){if(!app.includes(x))throw new Error('Missing v1.9.75 final playback safeguard: '+x)}
...
console.log('v1.9.75 final playback verification regression PASS');
