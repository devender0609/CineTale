...
const checks=[
 ['version advanced', /APP_VERSION = '1\.9\.76'/.test(app)&&/app\.js\?v=1\.9\.76/.test(index)],
...
if(bad)process.exit(1);console.log('v1.9.76 cloud final-video persistence regression PASS');
