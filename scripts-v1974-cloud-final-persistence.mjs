...
const checks=[
 ['version advanced', /APP_VERSION = '1\.9\.75'/.test(app)&&/app\.js\?v=1\.9\.75/.test(index)],
 ...
 ['final meta records cloud path and pipeline 9', /pipelineVersion:9,storagePath:null/.test(app)],
...
if(bad)process.exit(1);console.log('v1.9.75 cloud final-video persistence regression PASS');
