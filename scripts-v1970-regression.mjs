...
for(const x of must)if(!s.includes(x))throw new Error('Missing v1.9.77 final-output invariant: '+x);
...
console.log('v1.9.77 synchronized-audio + no-repeat + stable final player regression passed.');
