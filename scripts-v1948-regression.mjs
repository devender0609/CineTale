...
assert.ok(app.includes("const APP_VERSION = '1.9.80'"),'app version not advanced');
...
assert.ok(html.includes('/app.js?v=1.9.80')&&html.includes('/styles.css?v=1.9.80'),'browser cache busting not advanced');
