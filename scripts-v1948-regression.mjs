...
assert.ok(app.includes("const APP_VERSION = '1.9.79'"),'app version not advanced');
...
assert.ok(app.includes("sceneHasSpokenContent(s)&&!sceneHasValidatedLipSync(p,s)?'':'Video ready'"),'scene overlay does not suppress unsynced speaking-source status');
...
assert.ok(html.includes('/app.js?v=1.9.79')&&html.includes('/styles.css?v=1.9.79'),'browser cache busting not advanced');
